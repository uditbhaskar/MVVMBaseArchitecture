...
import com.example.sampleapp.di.component.DaggerFragmentComponent
import com.example.sampleapp.di.component.FragmentComponent
...
abstract class BaseFragment<VM : BaseViewModel> : Fragment() {
    ...
    private fun buildFragmentComponent() =
        DaggerFragmentComponent
            .builder()
            .applicationComponent((context!!.applicationContext as SampleApp).applicationComponent)
