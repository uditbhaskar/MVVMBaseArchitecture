...
import com.example.sampleapp.di.component.DaggerViewHolderComponent
import com.example.sampleapp.di.component.ViewHolderComponent
import com.example.sampleapp.di.module.ViewHolderModule
import com.example.sampleapp.utils.display.Toaster
...
abstract class BaseItemViewHolder<T : Any, VM : BaseItemViewModel<T>>(
    ...
    private fun buildViewHolderComponent() =
        DaggerViewHolderComponent
            .builder()
            .applicationComponent((itemView.context.applicationContext as SampleApp).applicationComponent)
